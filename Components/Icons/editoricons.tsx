...
export const BrushIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.43 2.43a4.5 4.5 0 00 8.642-1.128 2.25 2.25 0 01-2.43-2.43zM15.75 9.75c0-.414-.168-.79-.44-1.06l-1.72-1.72a1.125 1.125 0 01-.44-1.06V5.25a.75.75 0 011.5 0v.75a2.25 2.25 0 004.5 0V5.25a.75.75 0 011.5 0v.75a.75.75 0 01-1.5 0V5.25a.75.75 0 011.5 0v1.5c0 1.5-.672 2.84-1.754 3.754l-1.092.91A2.25 2.25 0 0115.75 9.75z" />
    </svg>
);
...
export const EraserIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" transform="rotate(-45 12 12)" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.03 5.96a7.5 7.5 0 00-10.606 10.608L16.03 5.961zM3.473 8.528L8.527 3.472" />
    </svg>
);
...
export const GlobeAltIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.35 0 2.673-.174 3.946-.504M12 21c-1.35 0-2.673-.174-3.946-.504m7.892-6.246a9.004 9.004 0 00-15.784 0M12 3c-1.35 0-2.673.174-3.946.504M12 3c1.35 0 2.673.174 3.946.504M12 3v1.5m0 6V3m0 6c-1.35 0-2.673.174-3.946.504m7.892 6.246a9.004 9.004 0 00-15.784 0" />
    </svg>
);
